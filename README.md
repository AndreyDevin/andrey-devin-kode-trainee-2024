...
Реализовать BackPressed (20 мин)
...
чтобы возвращаться на список с сохраненной позицией скроллинга.
...
то программа 3 секунды показывает текст ошибки (в это время кликлистнеры заблокированы),
а затем возвращается к последнему успешному состоянию.
...
Сказывается всё-таки мой малый опыт - видение что нужно сделать есть,
